sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("Coxinha_Hana.CoxinhaHana.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias Coxinha_Hana.CoxinhaHana.controller.ListSelector
			 */
			 ...
			 * @return {Coxinha_Hana.CoxinhaHana.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
